...
<head>
    ...
    <script>
        ...
        fbq('init', '263741198113539');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=263741198113539&ev=PageView&noscript=1"/></noscript>
    {{-- End Meta Pixel --}}
    ...
    <footer class="bg-olive-950 text-sand-200">
        <div class="mx-auto max-w-7xl px-6 py-16 lg:px-10">
            ...
            <div class="mt-14 border-t border-sand-50/10 pt-8 text-xs leading-relaxed text-sand-200/50">
                <p>© {{ date('Y') }} Vento · Comercializado por City Inmobiliaria. Todos los derechos reservados. · Aviso de Privacidad <span class="text-sand-200/30">· v1.0.7</span></p>
                <p class="mt-2">

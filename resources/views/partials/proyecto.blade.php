    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-10">
        <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div class="reveal-group">
                ...
                <h2 class="display mt-5 text-4xl font-light text-ink sm:text-5xl">Un proyecto residencial con <span class="accent-italic">identidad propia</span></h2>
                ...
                <p class="mt-4 text-base leading-relaxed text-ink-soft">
                    Cada departamento integra áreas cómodas para vivir el día a día, compartir y comenzar una nueva etapa.
                </p>

                <dl class="mt-10 grid grid-cols-2 gap-x-6 gap-y-5 sm:grid-cols-4">
                    @foreach ([
                        ['n' => '3', 'l' => 'Niveles'],
                        ['n' => '88·107', 'l' => 'm² por depto'],
                        ['n' => '2', 'l' => 'Recámaras'],
                ...
                <ul class="mt-8 flex flex-wrap gap-2.5">
                    @foreach (['2 cajones de estacionamiento', 'Balcón o patio privado', 'Bodega por departamento', 'Roof deck compartido', 'Acceso peatonal controlado', 'Portones eléctricos'] as $tag)
